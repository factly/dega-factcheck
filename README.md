...
To optimize the factcheck application for production, run:
...
[Service Discovery and Configuration with Consul]: https://www.jhipster.tech/documentation-archive/v5.6.0/microservices-architecture/#consul
