...
describe('Service Tests', () => {
  describe('Claimant Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Claimant('ID', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', async () => {
      ...
      it('should update a Claimant', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            tagLine: 'BBBBBB',
      ...
      it('should return a list of Claimant', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            tagLine: 'BBBBBB',
